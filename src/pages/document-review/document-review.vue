<template>
  <div>
    ...
    <el-table :data='tableData' style='width: 100%; margin-top: 20px'  v-loading='loading'>
      ...
      <el-table-column prop='roleName' label='是否通过'></el-table-column>
        ...
        <template slot-scope="scope">
          <el-dropdown  placement="bottom" class="table-module-content">
            ...
            <el-dropdown-menu slot="dropdown" class="new-option-list">
              <el-dropdown-item >
                <router-link :to="`/document-review-detail/${scope.row.id}`"><span class="viewIcon"></span>查看</router-link>
              </el-dropdown-item>
              <el-dropdown-item  >
                <router-link :to="`/document-review-detail/${scope.row.id}`"><span class="editIcon"></span>审核</router-link>
              </el-dropdown-item>
              <el-dropdown-item >
