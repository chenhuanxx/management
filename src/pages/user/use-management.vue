<template>
  <div>
    ...
    <div class="mt30 mb20">
      <el-button type='primary' @click.stop="addUse" icon="el-icon-circle-plus-outline" >新增用户</el-button>
    </div>
    <div class="new-dashed-line mt20 mb20"></div>
    <el-table :data='tableData' style='width: 100%; margin-top: 20px'  v-loading='loading'>
      <el-table-column prop='name' label='姓名'> </el-table-column>
      <el-table-column prop='use_name' label='用戶名'> </el-table-column>
        ...
        <template slot-scope="scope">
          <el-dropdown  placement="bottom" class="table-module-content">
            ...
            <el-dropdown-menu slot="dropdown" class="new-option-list">
              <el-dropdown-item >
                <router-link :to="`/use-management-detail/view/${scope.row.id}`"><span class="viewIcon"></span>查看用户</router-link>
              </el-dropdown-item>
              <el-dropdown-item  >
                <router-link :to="`/use-management-detail/edit/${scope.row.id}`"><span class="editIcon"></span>编辑用户</router-link>
              </el-dropdown-item>
              <el-dropdown-item >
                <a @click="deleteItem(scope.row.id)"><span class="deleteIcon"></span>删除用户</a>
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
